...
Enjoy my  message edting/spam filter.
Credits:
Davandi(me)
...
spammers: new Array('gavigator','professorgavin','suk','ilikewangs','nharmoniag','gavgar','gym leader dukeeee','soles','soles sha:dow'),
//rated mature
words: new Array('nigger','fag','nigga','niqqa','snen','wank','cunt','queef','fgt','kike','anal','cock','ann coulter','howard stern','nigga','cum','spamspamspam',"t1ts", "c0ck", "p0rn", "n1gger",'faggot','cumshot')
}
